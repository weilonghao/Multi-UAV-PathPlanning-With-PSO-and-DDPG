...
UAV_BASES = [(209, 391), (262, 338), (483, 401)]  # 无人机基地坐标
# =============================================

# ================== 数据准备 ==================
# 原始目标点数据（字典格式）
original_targets = {
    0: (7762, 4595), 1: (2233, 10), 2: (5530, 1424), 3: (401, 841), 4: (3082, 1644),
    5: (7608, 4458), 6: (7573, 3716), 7: (5989, 2873), 8: (6898, 1885), 9: (1112, 2049),
    10: (5468, 2606), 11: (6426, 3173), 12: (4706, 2674), 13: (4612, 2035), 14: (6347, 2683),
...
class PSOOptimizer:
    def __init__(self, targets, num_uav=3, max_L=30000, survival_probs=None, uav_bases=None):
        ...
        self.m = num_uav
        self.uav_speeds = [6.0, 7.0, 8.2][:num_uav]
        self.max_L = max_L
        ...
        for target_idx in order:
            ...
            for uav_id in range(self.m):
                ...
                if not uav_paths[uav_id]:
                    ...
                    new_dist = uav_distances[uav_id] + add_dist - euclidean(self.targets[last],
                                                                            current_base) + euclidean(
                        self.targets[target_idx], current_base)
